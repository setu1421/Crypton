...
public class DatabaseHandlerForSentMsges extends SQLiteOpenHelper {
    ...
    public DatabaseHandlerForSentMsges(Context context) {
   ...
   /* Contact getContact(int id) {
    ...
    public ArrayList<SentSMS> getAllsms() {
    ...
    public int updateContact(SentSMS sms) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteSMS(SentSMS sms) {
        SQLiteDatabase db = this.getWritableDatabase();
