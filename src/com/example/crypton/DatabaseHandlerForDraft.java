...
public class DatabaseHandlerForDraft extends SQLiteOpenHelper {
    ...
    public DatabaseHandlerForDraft(Context context) {
   ...
   /* Contact getContact(int id) {
    ...
    public ArrayList<DraftSMS> getAllsms() {
        ArrayList<DraftSMS> smsList = new ArrayList<DraftSMS>();
        // Select All Query
    ...
    public int updateContact(DraftSMS sms) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteSMS(DraftSMS sms) {
        SQLiteDatabase db = this.getWritableDatabase();
