...
ListView list;
ArrayList<DraftSMS> your_array_list = new ArrayList<DraftSMS>();
...
public boolean onContextItemSelected(MenuItem item) {
    if (item.getTitle() == "Edit") {
    	try{
			Intent i = new Intent(DRAFT.this,CREATEMESSAGEfromDRAFT.class); 
		Bundle bundle=new Bundle();
		bundle.putString("sms",sms);
		bundle.putString("phoneno",phonenumber);
		i.putExtras(bundle);
		DRAFT.this.startActivity(i);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
    	...
    	try{
			db.deleteSMS(new DraftSMS(sms,phonenumber)); 
			db.close();

			Intent i = new Intent(DRAFT.this,DRAFT.class); 
    		DRAFT.this.startActivity(i);
		}catch(Exception e)
		{
			e.printStackTrace();
...
public class CustomAdapter extends BaseAdapter {
    ...
    private ArrayList<DraftSMS> _data;
    Context _c;
    
    CustomAdapter (ArrayList<DraftSMS> data, Context c){
        _data = data;
        _c = c;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
         ...
         if (v == null) 
         {
            ...
            v = vi.inflate(R.layout.draft_item_message, null);
         }
         ...
         //  TextView timeView = (TextView)v.findViewById(R.id.time);
           ...
           DraftSMS msg = _data.get(position);
